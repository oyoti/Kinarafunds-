function renderSidebar(activePage) {
  ...
  const links = [
    ...
    },
    {
      ...
      icon: `<svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 21h8m-4-4v4M7 4h10v4a5 5 0 01-10 0V4zm-3 0h3v3a3 3 0 01-3-3zm16 0h-3v3a3 3 0 003-3z"/></svg>`
    },
    {
